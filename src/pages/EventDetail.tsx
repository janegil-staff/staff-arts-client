...
export default function EventDetail() {
  ...
  return (
    <div className="min-h-screen max-w-2xl mx-auto">
      ...
      <div
        className="relative"
        style={{ height: coverUrl ? "340px" : "180px" }}
      >
        {coverUrl ? (
          <img
            src={coverUrl}
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.4) 0%, transparent 30%, var(--bg) 100%)",
          }}
        />
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="px-8 pb-24">
        ...
        {event.organizer && (
          <div
            className="flex items-center gap-3 p-4 rounded-2xl mb-6 cursor-pointer hover:bg-white/5"
            style={{
              background: "var(--bg-elevated)",
              border: "1px solid var(--border)",
            }}
          ...
          >
            <img
              src={
                ...
                `https://api.dicebear.com/7.x/avataaars/svg?seed=${event.organizer._id}`
              }
        ...
        <div className="flex gap-3 mb-6">
          <button
            className="flex-1 py-4 rounded-xl font-semibold text-white transition-opacity"
