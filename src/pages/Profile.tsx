...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    api
      .get("/mobile/auth/me")
      .then((r) => {
        setUser(r.data.data?.user || r.data.data || r.data.user || r.data);
      })
      ...
      <div className="relative" style={{ height: "180px" }}>
        {user.coverImage ? (
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #0d3b2e 0%, #1e2d4a 100%)",
            }}
          />
        )}
      ...
      >
        <div className="flex">
          {[
            {
              label: "Followers",
              value: user.followerCount ?? user.followersCount ?? 0,
            },
